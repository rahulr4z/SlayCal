          ...
          <div className="hidden lg:block">
            ...
            >
              <div className="glass rounded-3xl p-8 border border-white/10">
                ...
                <div className="mt-8 p-6 bg-purple-500/20 rounded-2xl border border-purple-400/30">
                ...
                >
                  ...
                  >
                    ...
                    <div className="h-full bg-gradient-to-br from-gray-900 via-purple-900/20 to-gray-900 overflow-hidden relative">
                      {/* Chat Header */}
                      <div className="pt-12 pb-4 px-4 bg-purple-600/30 border-b border-white/10">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-3 pb-8 bg-gradient-to-t from-gray-900 via-gray-900/95 to-transparent">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="p-2.5 bg-purple-600 text-white rounded-2xl disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
                          >
